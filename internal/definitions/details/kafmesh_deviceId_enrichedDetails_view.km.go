...
type KafmeshDeviceIDEnrichedDetails_View interface {
	Keys() []string
	Get(key string) (*deviceId.EnrichedDetails, error)
}

type KafmeshDeviceIDEnrichedDetails_View_impl struct {
	view *goka.View
}

func New_KafmeshDeviceIDEnrichedDetails_View(options runner.ServiceOptions) (*KafmeshDeviceIDEnrichedDetails_View_impl, error) {
	...
	return &KafmeshDeviceIDEnrichedDetails_View_impl{
		view: view,
	}, nil
}

func (v *KafmeshDeviceIDEnrichedDetails_View_impl) Watch(ctx context.Context) func() error {
	return func() error {
		return v.view.Run(ctx)
	}
}

func (v *KafmeshDeviceIDEnrichedDetails_View_impl) Keys() []string {
	return v.Keys()
}

func (v *KafmeshDeviceIDEnrichedDetails_View_impl) Get(key string) (*deviceId.EnrichedDetails, error) {
