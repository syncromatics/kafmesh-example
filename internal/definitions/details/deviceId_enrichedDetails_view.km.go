...
type DeviceIDEnrichedDetails_View interface {
	Keys() []string
	Get(key string) (*deviceId.EnrichedDetails, error)
}

type DeviceIDEnrichedDetails_View_impl struct {
	view *goka.View
}

func New_DeviceIDEnrichedDetails_View(options runner.ServiceOptions) (*DeviceIDEnrichedDetails_View_impl, error) {
	...
	return &DeviceIDEnrichedDetails_View_impl{
		view: view,
	}, nil
}

func (v *DeviceIDEnrichedDetails_View_impl) Watch(ctx context.Context) func() error {
	return func() error {
		return v.view.Run(ctx)
	}
}

func (v *DeviceIDEnrichedDetails_View_impl) Keys() []string {
	return v.Keys()
}

func (v *DeviceIDEnrichedDetails_View_impl) Get(key string) (*deviceId.EnrichedDetails, error) {
